...
for lin in hand:
   ...
   # line_words = lin.split()   # split into an array
    ...
    #
    colon_index = lin.find(":")     # get index of colon after hours
    start_index = colon_index -2    # Get start index,
    subtraction = len(lin)-colon_index
    hour = lin[start_index:-subtraction]
